                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-hover table-condensed">
                            <tr>
                                ...
                                <td> Albert </td>
                                <td> : </td>
                                <td> ontrairement à une opinion répandue, le Lorem Ipsum n'est pas simplement du texte aléatoire. Il trouve ses racines dans une oeuvre de la littérature latine classiqu </td>
                            </tr>
                            <tr>
                                <td> 10:32:45 </td>
                                <td> Albert </td>
